...
public class DependencyCheckingTaskTest extends ClassycleTaskTestCase {
    ...
    public void testDependentOnlyOn() throws Exception {
        ...
        assertThat(outputLines, Matchers.arrayContaining("    -> example.A", "    -> example.A", "    -> example.A", "    -> example.p.A",
                "    -> example.p.A", "    -> java.lang.Class", "    -> java.lang.Object", "    -> java.lang.Object",
                "    -> java.lang.Thread", "  Unexpected dependencies found:", "  Unexpected dependencies found:",
                "  Unexpected dependencies found:", "  example.B", "  example.B$M", "  example.B$M", "  example.B$M", "  example.BofA",
                "  example.BofA", "  example.p.A", "check [set] dependentOnlyOn java.lang.*", "check example.B* dependentOnlyOn *A",
